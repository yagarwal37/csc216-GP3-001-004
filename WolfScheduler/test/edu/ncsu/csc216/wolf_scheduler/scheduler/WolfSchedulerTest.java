...
public class WolfSchedulerTest {
	 ...
	 * 
	 * @throws IOException if the files are unable to be reset
	 */
	@Before
	...
	public void testAddEventToSchedule() {
		...
		ws.addEventToSchedule("Lunch", "MWF", 1100, 1300, "");
		
		try {
			ws.addEventToSchedule("Brunch", "M", 1030, 1200, "");
			fail();
		} catch(IllegalArgumentException e) {
	...
	public void testGetScheduledActivities() {
		...
		assertTrue(ws.addCourseToSchedule(NAME, SECTION));
		assertTrue(ws.addCourseToSchedule("CSC 226", "001"));
		ws.addEventToSchedule("Lunch", "TH", 1200, 1300, "Food");
		assertTrue(ws.addCourseToSchedule("CSC 116", "002"));
		...
		assertEquals("TH 12:00PM-1:00PM", schedule[2][3]);
		//Row 3
	...
	public void testGetFullScheduledActivities() {
		...
		assertEquals("TH 12:00PM-1:00PM", schedule[2][5]);
